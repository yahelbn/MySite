...
export const DataHebrew = {
  ...
  homeObjTwo: {
    ...
    description:
      "מערכת קונטוטק פועלת כשירות SAAS אונליין ומאפשרת גישה לתהליך הן לספקים והן ללקוחות היא בנויה על בסיס מספר עקרונות עיקריים :1.שמירה על קשר מלא אונליין בזמן אמת בין הספק ללקוח בכל שלבי התהליך. 2.מעקב מלא אחרי היסטוריית הפעולות והתשלומים, מבוסס blockchain ledger, אשר מאפשר מעקב אמין ומאובטח אחרי כל פעולה שבוצעה. 3.משלבת טכנולוגיות fintech מתקדמות ובכללם מערכות NLP ו-OCR. ",
    buttonLabel: "התחל עכשיו",
    imgStart: true,
  ...
  heroSection: {
    heroh1: "פעולות בין עסקים נהפך לקל יותר",
